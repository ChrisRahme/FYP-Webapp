...
!(function (t, e) {
    ...
    (j.prototype = {
        ...
        (j.prototype.spaces = { rgb: ["red", "green", "blue"], hsl: ["hue", "saturation", "lightness"], hsv: ["hue", "saturation", "value"], hwb: ["hue", "whiteness", "blackness"], cmyk: ["cyan", "magenta", "yellow", "black"] }),
        (j.prototype.maxes = { rgb: [255, 255, 255], hsl: [360, 100, 100], hsv: [360, 100, 100], hwb: [360, 100, 100], cmyk: [100, 100, 100, 100] }),
    ...
    var lt = {
            ...
            toPadding: function (t) {
                var e, i, n, a;
                return Z.isObject(t) ? ((e = +t.top || 0), (i = +t.right || 0), (n = +t.bottom || 0), (a = +t.left || 0)) : (e = i = n = a = +t || 0), { top: e, right: i, bottom: n, left: a, height: e + n, width: a + i };
            },
                    ...
                    i.borderWidth &&
                        ("inner" === i.borderAlign
                            ? (e.beginPath(),
                              ...
                              i.innerRadius > r ? ((t = r / i.innerRadius), e.arc(i.x, i.y, i.innerRadius - r, a + t, n - t, !0)) : e.arc(i.x, i.y, r, a + Math.PI / 2, n - Math.PI / 2),
                              e.closePath(),
                              e.clip(),
                              e.beginPath(),
    ...
    ot._set("global", { elements: { line: { tension: 0.4, backgroundColor: St, borderWidth: 3, borderColor: St, borderCapStyle: "butt", borderDash: [], borderDashOffset: 0, borderJoinStyle: "miter", capBezierPoints: !0, fill: !0 } } });
    var Dt = gt.extend({
            draw: function () {
                var t,
                    e,
                ...
                for (
                    ...
                    (e = s[t]),
                        ...
                        (n = e._view),
                        0 === t ? n.skip || (r.moveTo(n.x, n.y), (d = t)) : ((i = -1 === d ? i : s[d]), n.skip || ((d !== t - 1 && !o) || -1 === d ? r.moveTo(n.x, n.y) : ut.canvas.lineTo(r, i._view, e._view), (d = t)));
                r.stroke(), r.restore();
            },
        }),
            ...
            draw: function (t) {
                ...
                e.skip ||
                    ((void 0 === t || ut.canvas._isPointInArea(e, t)) &&
                        ((i.strokeStyle = e.borderColor || u), (i.lineWidth = Ct(e.borderWidth, l.elements.point.borderWidth)), (i.fillStyle = e.backgroundColor || u), ut.canvas.drawPoint(i, n, r, o, s, a)));
            },
        }),
    ...
    function Ft(t) {
        var e, i, n, a, r;
        return (
            At(t) ? ((r = t.width / 2), (e = t.x - r), (i = t.x + r), (n = Math.min(t.y, t.base)), (a = Math.max(t.y, t.base))) : ((r = t.height / 2), (e = Math.min(t.x, t.base)), (i = Math.max(t.x, t.base)), (n = t.y - r), (a = t.y + r)),
    ...
    ot._set("bar", { hover: { mode: "label" }, scales: { xAxes: [{ type: "category", categoryPercentage: 0.8, barPercentage: 0.9, offset: !0, gridLines: { offsetGridLines: !0 } }], yAxes: [{ type: "linear" }] } });
    var jt = kt.extend({
            ...
            updateElement: function (t, e, i) {
                ...
                (t._xScale = n.getScaleForId(a.xAxisID)),
                    ...
                    (t._index = e),
                    (t._model = { backgroundColor: o.backgroundColor, borderColor: o.borderColor, borderSkipped: o.borderSkipped, borderWidth: o.borderWidth, datasetLabel: r.label, label: n.chart.data.labels[e] }),
            ...
            calculateBarValuePixels: function (t, e) {
                ...
                return (
                    (r = d.getPixelForValue(v)), (s = (o = d.getPixelForValue(v + f)) - r), void 0 !== g && Math.abs(s) < g && ((s = g), (o = (f >= 0 && !h) || (f < 0 && h) ? r - g : r + g)), { size: s, base: r, head: o, center: o + s / 2 }
                );
            },
    ...
    var ie = kt.extend({
            ...
            update: function (t) {
                ...
                for (
                    u && (void 0 !== l.tension && void 0 === l.lineTension && (l.lineTension = l.tension), (r._scale = s), (r._datasetIndex = n.index), (r._children = o), (r._model = n._resolveLineOptions(r)), r.pivot()),
                        e = 0,
                        i = o.length;
                    e < i;
                    ++e
            ...
            updateBezierControlPoints: function () {
                ...
                if (a.options.elements.line.capBezierPoints)
                    for (t = 0, e = l.length; t < e; ++t)
                        (i = l[t]._model),
                            te(i, s) &&
                                (t > 0 && te(l[t - 1]._model, s) && ((i.controlPointPreviousX = u(i.controlPointPreviousX, s.left, s.right)), (i.controlPointPreviousY = u(i.controlPointPreviousY, s.top, s.bottom))),
                                t < l.length - 1 && te(l[t + 1]._model, s) && ((i.controlPointNextX = u(i.controlPointNextX, s.left, s.right)), (i.controlPointNextY = u(i.controlPointNextY, s.top, s.bottom))));
            },
            draw: function () {
                var t,
                    e = this.chart,
    ...
    var le = kt.extend({
        ...
        update: function (t) {
            var e,
                ...
                l = n.getDataset();
            for (
                void 0 !== l.tension && void 0 === l.lineTension && (l.lineTension = l.tension), r._scale = s, r._datasetIndex = n.index, r._children = o, r._loop = !0, r._model = n._resolveLineOptions(r), r.pivot(), e = 0, i = o.length;
                e < i;
                ++e
            )
                n.updateElement(o[e], e, t);
    ...
    var xe = {
        ...
        update: function (t, e, i) {
            ...
            function A(t) {
                t.isHorizontal()
                    ? ((t.left = t.fullWidth ? r : w.left), (t.right = t.fullWidth ? e - o : w.left + _), (t.top = O), (t.bottom = O + t.height), (O = t.bottom))
                    ...
                    c.filter &&
                        ...
                        (y = (function (t, e, i, n) {
                            var a = t.x,
                                ...
                                c = l + s;
                            return (
                                "right" === u ? (a -= e.width) : "center" === u && ((a -= e.width / 2) + e.width > n.width && (a = n.width - e.width), a < 0 && (a = 0)),
    ...
    ut.extend(ni.prototype, {
        ...
        initialize: function () {
            var t = this;
            return (
                He.notify(t, "beforeInit"), ut.retinaScale(t, t.options.devicePixelRatio), t.bindEvents(), t.options.responsive && t.resize(!0), t.ensureScalesHaveIDs(), t.buildOrUpdateScales(), t.initToolTip(), He.notify(t, "afterInit"), t
            );
        },
        clear: function () {
                ...
                if (e._isVisible()) {
                    ...
                    if (
                            ...
                            if (!ut.isNullOrUndef(n.label)) {
                                ...
                                if (p) {
                                    ...
                                    z < e.left - 1e-7 && (u = "rgba(0,0,0,0)"),
                                        ...
                                        "top" === f
                                            ? ((w = F(o, t.top, A) + A / 2), (P = t.bottom), (L = ((g ? 1 : 0.5) - N) * _), (W = g ? "left" : "center"), (R = e.bottom - V))
                                            : ((w = t.top), (P = F(o, t.bottom, A) - A / 2), (L = (g ? 0 : 0.5) * _), (W = g ? "right" : "center"), (R = e.top + V));
                                } else {
                                    var H = (m ? 0 : D) + M;
                        ...
                        if (p) (R = e.left + (e.right - e.left) / 2), (L = "bottom" === f ? e.bottom - Y - T.bottom : e.top + Y + T.top);
                            ...
                            var N = "left" === f;
                            (R = N ? e.left + Y + T.top : e.right - Y - T.top), (L = e.top + (e.bottom - e.top) / 2), (W = N ? -0.5 * Math.PI : 0.5 * Math.PI);
                        }
                    ...
                    if (A) {
                        ...
                        p ? ((z = F(o, e.left, B) - B / 2), (V = F(o, e.right, j) + j / 2), (H = E = n)) : ((H = F(o, e.top, B) - B / 2), (E = F(o, e.bottom, j) + j / 2), (z = V = n)),
                            (s.lineWidth = A),
    ...
    var Si = fi.extend({
            ...
            getPixelForValue: function (t) {
                ...
                return (
                    ...
                    t !== n && (0 === n && ((e -= h = ki(s.fontSize, ot.global.defaultFontSize)), (n = d)), 0 !== t && (h += (e / (u(a) - u(n))) * (u(t) - u(n))), (i += r * h)),
                    i
                );
            },
            getValueForPixel: function (t) {
            ...
            determineDataLimits: function () {
                ...
                for (t = 0, i = (s.data.datasets || []).length; t < i; ++t)
                    if (s.isDatasetVisible(t))
                        if (((a = s.data.datasets[t].data), ut.isObject(a[0]))) for (g[t] = [], e = 0, n = a.length; e < n; ++e) (r = $i(o, a[e])), f.push(r), (g[t][e] = r);
                        else {
                    ...
                    (n._offsets = (function (t, e, i, n, a) {
                        ...
                        return (
                            a.offset &&
                                ...
                                a.time.max || ((o = qi(t, "time", e[e.length - 1], "pos")), (l = 1 === e.length ? o : (o - qi(t, "time", e[e.length - 2], "pos")) / 2))),
                            { start: s, end: l }
                        );
                    })(n._table, u, 0, 0, o)),
            ...
            ((function (t, e) {
                t.exports = (function () {
                    ...
                    function It(t, e, i) {
                        t.isValid() &&
                            !isNaN(i) &&
                            ("FullYear" === e && Dt(t.year()) && 1 === t.month() && 29 === t.date() ? t._d["set" + (t._isUTC ? "UTC" : "") + e](i, t.month(), At(i, t.month())) : t._d["set" + (t._isUTC ? "UTC" : "") + e](i));
                    }
                    function At(t, e) {
                        ...
                        if (!t._d) {
                            for (
                                a = (function (t) {
                                    ...
                                    null != t._dayOfYear &&
                                        ((o = ge(t._a[pt], a[pt])), (t._dayOfYear > St(o) || 0 === t._dayOfYear) && (f(t)._overflowDayOfYear = !0), (i = Ht(o, 0, t._dayOfYear)), (t._a[vt] = i.getUTCMonth()), (t._a[yt] = i.getUTCDate())),
                                    e = 0;
                                e < 3 && null == t._a[e];
                                ++e
                            )
                        ...
                        if (t._f !== n.ISO_8601)
                            if (t._f !== n.RFC_2822) {
                                ...
                                for (a = U(t._f, t._locale).match(z) || [], e = 0; e < a.length; e++)
                                    (r = a[e]),
                                        (i = (s.match(dt(r, t)) || [])[0]) && ((o = s.substr(0, s.indexOf(i))).length > 0 && f(t).unusedInput.push(o), (s = s.slice(s.indexOf(i) + i.length)), (u += i.length)),
                                ...
                                (f(t).charsLeftOver = l - u),
                                    ...
                                    (t._a[bt] =
                                        ((d = t._locale),
                                        (h = t._a[bt]),
                                        null == (c = t._meridiem) ? h : null != d.meridiemHour ? d.meridiemHour(h, c) : null != d.isPM ? ((g = d.isPM(c)) && h < 12 && (h += 12), g || 12 !== h || (h = 0), h) : h)),
                                    me(t),
                                    fe(t);
                            } else Ce(t);
                        else we(t);
                                            ...
                                            ? (function (t) {
                                                  ...
                                                  for (a = 0; a < t._f.length; a++)
                                                      (r = 0),
                                                          ...
                                                          (e._f = t._f[a]),
                                                          Pe(e),
                                                          g(e) && ((r += f(e).charsLeftOver), (r += 10 * f(e).unusedTokens.length), (f(e).score = r), (null == n || r < n) && ((n = r), (i = e)));
                                                  h(t, i || e);
                                              })(t)
                                            : i
                                            ? Pe(t)
                    ...
                    function qe(t, e) {
                        ...
                        return (
                            Ye(t)
                                ...
                                : (h = Ue.exec(t))
                                ? ((i = "-" === h[1] ? -1 : 1), (u = { y: 0, d: k(h[yt]) * i, h: k(h[bt]) * i, m: k(h[xt]) * i, s: k(h[_t]) * i, ms: k(Ne(1e3 * h[kt])) * i }))
                                : (h = Ge.exec(t))
                                ? ((i = "-" === h[1] ? -1 : 1), (u = { y: Ze(h[2], i), M: Ze(h[3], i), w: Ze(h[4], i), d: Ze(h[5], i), h: Ze(h[6], i), m: Ze(h[7], i), s: Ze(h[8], i) }))
                                : null == u
                                ? (u = {})
                                : "object" == typeof u &&
                                  ("from" in u || "to" in u) &&
                                  ((r = Ie(u.from)),
                                  (o = Ie(u.to)),
                                  (a = r.isValid() && o.isValid() ? ((o = Ee(o, r)), r.isBefore(o) ? (l = $e(r, o)) : (((l = $e(o, r)).milliseconds = -l.milliseconds), (l.months = -l.months)), l) : { milliseconds: 0, months: 0 }),
                                  ((u = {}).ms = a.milliseconds),
                                  (u.M = a.months)),
                            (n = new We(u)),
                    ...
                    (bi.add = Je),
                        ...
                        (bi.isSame = function (t, e) {
                            ...
                            return (
                                ...
                                ("millisecond" === (e = R(e) || "millisecond") ? this.valueOf() === n.valueOf() : ((i = n.valueOf()), this.clone().startOf(e).valueOf() <= i && i <= this.clone().endOf(e).valueOf()))
                            );
                        }),
                        ...
                        (bi.utcOffset = function (t, e, i) {
                            ...
                            if (null != t) {
                                ...
                                return (
                                    ...
                                    (this._isUTC = !0),
                                    null != a && this.add(a, "m"),
                                    r !== t && (!e || this._changeInProgress ? Ke(this, qe(t - r, "m"), 1, !1) : this._changeInProgress || ((this._changeInProgress = !0), n.updateOffset(this, !0), (this._changeInProgress = null))),
                                    this
                                );
                            }
                    ...
                    (_i.calendar = function (t, e, i) {
                        ...
                        (_i.monthsShortRegex = function (t) {
                            return this._monthsParseExact
                                ...
                                : (d(this, "_monthsShortRegex") || (this._monthsShortRegex = Nt), this._monthsShortStrictRegex && t ? this._monthsShortStrictRegex : this._monthsShortRegex);
                        }),
                        (_i.week = function (t) {
                        ...
                        (function (t, e, i, n, a, r) {
                            ...
                            for (t.beginPath(), o = 0, s = f + !!r; o < s; ++o)
                                (d = i((u = e[(l = o % f)]._view), l, n)),
                                    (h = dn(u)),
                                    (c = dn(d)),
                                    h && c ? ((v = m.push(u)), (y = p.push(d))) : v && y && (g ? (h && m.push(u), c && p.push(d)) : (hn(t, m, p, v, y), (v = y = 0), (m = []), (p = [])));
    ...
    var pn = gt.extend({
        ...
        draw: function () {
            ...
            if (e.display) {
                var l,
                    ...
                    c = h.size;
                (u.textAlign = "left"), (u.textBaseline = "middle"), (u.lineWidth = 0.5), (u.strokeStyle = d), (u.fillStyle = d), (u.font = h.string);
                var f = mn(i, c),
                    g = t.legendHitBoxes,
                    m = t.isHorizontal();
                ...
                ut.each(t.legendItems, function (n, d) {
                    var h = u.measureText(n.text).width,
                        ...
                        b = l.y;
                    m
                        ? d > 0 && y + v + i.padding > t.left + t.minSize.width && ((b = l.y += p), l.line++, (y = l.x = t.left + (o - s[l.line]) / 2 + i.padding))
                        : d > 0 && b + p > t.top + t.minSize.height && ((y = l.x = y + t.columnWidths[l.line] + i.padding), (b = l.y = t.top + i.padding), l.line++),
                        (function (t, i, n) {
                            if (!(isNaN(f) || f <= 0)) {
                                u.save();
        ...
        _getLegendItemAt: function (t, e) {
            ...
            if (t >= r.left && t <= r.right && e >= r.top && e <= r.bottom)
                for (a = r.legendHitBoxes, i = 0; i < a.length; ++i) if (t >= (n = a[i]).left && t <= n.left + n.width && e >= n.top && e <= n.top + n.height) return r.legendItems[i];
            return null;
        },
        handleEvent: function (t) {
            var e,
        ...
        draw: function () {
            ...
            if (i.display) {
                ...
                (e.fillStyle = ut.valueOrDefault(i.fontColor, ot.global.defaultFontColor)),
                    (e.font = o.string),
                    t.isHorizontal() ? ((a = h + (f - h) / 2), (r = d + l), (n = f - h)) : ((a = "left" === i.position ? h + l : f - l), (r = d + (c - d) / 2), (n = c - d), (u = Math.PI * ("left" === i.position ? -0.5 : 0.5))),
                    e.save(),
                    e.translate(a, r),
                    e.rotate(u),
                    (e.textAlign = "center"),
                    ...
                    (n = d[e]),
                        ...
                        n.model.skip ||
                            ...
                            (ut.almostEquals(n.deltaK, 0, this.EPSILON)
                                ? (n.mK = a.mK = 0)
                                : ((r = n.mK / n.deltaK), (o = a.mK / n.deltaK), (l = Math.pow(r, 2) + Math.pow(o, 2)) <= 9 || ((s = 3 / Math.sqrt(l)), (n.mK = r * s * n.deltaK), (a.mK = o * s * n.deltaK))));
                for (e = 0; e < h; ++e)
                    (n = d[e]).model.skip ||
                        ((i = e > 0 ? d[e - 1] : null),
                        (a = e < h - 1 ? d[e + 1] : null),
